...
!
```
[Nota Bene][nb]: Depending on your terminal, the colors of the pieces may be inverted. To correct this, toggle the boolean value of the `inverted` setting within `play` with `vim` (or any lesser text editor of your choosing).
